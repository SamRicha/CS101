...
def involved(courses, person):
    ...
    for hexamester in courses:
        for course in courses[hexamester]:
            for thing in courses[hexamester][course]:
                if courses[hexamester][course][thing] == person:
                    if hexamester in personInvolvement:
                        personInvolvement[hexamester].append(course)
                    else:
                        personInvolvement[hexamester] = [course]
